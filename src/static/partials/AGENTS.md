...
| **`tab_easy_apply.html`** | [`tab_easy_apply.html`](file:///Users/apple/Byten/linkedInScrapper/src/static/partials/tab_easy_apply.html) | LinkedIn Easy Apply workspace (`#tabEasyApply`), crawler header form, 5-stat KPI ribbon (Ready, Screening, Applied, Failed, Not Found), filter pills & search box, floating batch action banner (`#easyBatchToolbar`), responsive data table (`#easyApplyTableBody`), details modal (`#modalEasyDetails`), and dedicated Screening Questionnaire Modal (`#modalScreeningQuestions`). |
