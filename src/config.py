...
def load_config() -> Dict[str, Any]:
    ...
    # Override search_query and chatgpt_url from database settings table
    try:
...
def save_config(new_config: Dict[str, Any]) -> Dict[str, Any]:
    """Save configuration to config.json and persist search_query & chatgpt_url in DB."""
    # Persist search_query and chatgpt_url in PostgreSQL
    try:
